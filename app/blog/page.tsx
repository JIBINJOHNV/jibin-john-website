...
export const metadata: Metadata = { title: "Blog | Jibin John, PhD", description: "Future research notes, statistical-genetics explainers, reproducible bioinformatics workflows and career-learning reflections." };
...
export default function BlogPage() {
  return <Site active="Blog"><PageHero eyebrow="Blog" title="Research notes, methods and practical workflows." intro="This permanent editorial space is prepared for future articles that make complex genetics and bioinformatics work clearer, more reproducible and easier to apply." actions={<a className="button button-primary" href="#series">Explore planned series</a>} aside={<div className="editorial-card"><span>Editorial focus</span><strong>Clear science.<br />Reproducible methods.<br />Practical interpretation.</strong></div>} />
