...
export default function AboutPage() {
  return <Site active="About Me">
    ...
    <PageHero
      ...
      aside={<div className="about-profile-card"><div className="about-profile-image"><img src="/jibin-professional-portrait.png" alt="Professional portrait of Jibin John" /></div><div><p>Professional profile</p><strong>Jibin John, PhD</strong><span>Research Scientist · Bioinformatician · Computational Biologist</span><ul><li>Human genetics</li><li>GWAS &amp; post-GWAS</li><li>Multi-omics</li><li>Scientific computing</li></ul></div></div>}
    />
